...
HtmlCode = HtmlCode.replace("recognition.lang = '{InputLanguage}';", f"recognition.lang = '{InputLanguage}';")
...
# Function to translate text to English using the mtranslate library.
